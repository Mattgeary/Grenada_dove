...
png("rcpboth_2050.png", width = 12*ppi, height = 12*ppi, res = ppi)
par(mfrow = c(1,2), cex = 2, mar = c(5,2,4,8)+0.1)
plot(climate.fun(forest.mod, future.PER.50[[1]]), axes = FALSE, box = FALSE)
plot(GRD, add = TRUE)
points(forest.env[,2], forest.env[,1], pch = 16,  col = (forest.env$pres+2)*2, cex =2)
points(test.env[,2], test.env[,1], pch = 16,  col = (test.env$pres+2)*2, cex =2)
...
north.arrow(-61.777, 12.21, 0.005)
par(cex = 2)
plot(climate.fun(forest.mod, future.PER.50[[2]]), axes = FALSE, box = FALSE)
plot(GRD, add = TRUE)
points(forest.env[,2], forest.env[,1], pch = 16,  col = (forest.env$pres+2)*2, cex =2)
points(test.env[,2], test.env[,1], pch = 16,  col = (test.env$pres+2)*2, cex =2)
scalebar(0.045, padding = c(2, 80), labels = "5 km", cex = 2)
...
png("rcpboth_2070.png", width = 15*ppi, height = 12*ppi, res = ppi)
par(mfrow = c(1,2), cex = 2, mar = c(2,2,2,6)+0.1)
plot(climate.fun(forest.mod, future.PER.70[[1]]), axes = FALSE, box = FALSE)
plot(GRD, add = TRUE)
points(forest.env[,2], forest.env[,1], pch = 16,  col = (forest.env$pres+2)*2, cex =2)
points(test.env[,2], test.env[,1], pch = 16,  col = (test.env$pres+2)*2, cex =2)
...
north.arrow(-61.777, 12.21, 0.005)
par(cex = 2)
plot(climate.fun(forest.mod, future.PER.70[[2]]), axes = FALSE, box = FALSE)
plot(GRD, add = TRUE)
points(forest.env[,2], forest.env[,1], pch = 16,  col = (forest.env$pres+2)*2, cex =2)
points(test.env[,2], test.env[,1], pch = 16,  col = (test.env$pres+2)*2, cex =2)
scalebar(0.045, padding = c(2, 80), labels = "5 km", cex = 2)
...
png("PresAbs_both_2050.png", width = 15*ppi, height = 12*ppi, res = ppi)
par(mfrow = c(1,2), cex = 2, mar = c(2,2,2,6)+0.1)
thresh.rcl <- matrix(c(-1, 0.343, 0, 0.343, 1.5, 1), nrow=2, ncol=3, byrow=TRUE)
plot(reclassify(climate.fun(forest.mod, future.PER.50[[1]]), thresh.rcl), axes = FALSE, box = FALSE)
plot(GRD, add = TRUE)
...
north.arrow(-61.777, 12.21, 0.005)
par(cex = 2)
plot(reclassify(climate.fun(forest.mod, future.PER.50[[2]]), thresh.rcl), axes = FALSE, box = FALSE)
plot(GRD, add = TRUE)
points(forest.env[,2], forest.env[,1], pch = 16,  col = (forest.env$pres+2)*2, cex =2)
points(test.env[,2], test.env[,1], pch = 16,  col = (test.env$pres+2)*2, cex =2)
scalebar(0.045, padding = c(2, 80), labels = "5 km", cex = 2)
...
png("PresAbs_both_2070.png", width = 15*ppi, height = 12*ppi, res = ppi)
par(mfrow = c(1,2), cex = 2, mar = c(2,2,2,6)+0.1)
thresh.rcl <- matrix(c(-1, 0.343, 0, 0.343, 1.5, 1), nrow=2, ncol=3, byrow=TRUE)
plot(reclassify(climate.fun(forest.mod, future.PER.70[[1]]), thresh.rcl), axes = FALSE, box = FALSE)
plot(GRD, add = TRUE)
...
north.arrow(-61.777, 12.21, 0.005)
par(cex = 2)
plot(reclassify(climate.fun(forest.mod, future.PER.70[[2]]), thresh.rcl), axes = FALSE, box = FALSE)
plot(GRD, add = TRUE)
points(forest.env[,2], forest.env[,1], pch = 16,  col = (forest.env$pres+2)*2, cex =2)
points(test.env[,2], test.env[,1], pch = 16,  col = (test.env$pres+2)*2, cex =2)
scalebar(0.045, padding = c(2, 80), labels = "5 km", cex = 2)
